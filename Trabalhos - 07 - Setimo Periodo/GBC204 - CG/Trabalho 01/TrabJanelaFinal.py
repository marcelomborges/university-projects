...
def Simbolos():
	...
	Menu.append((2,Bottons[2][0]+10,Bottons[2][1]+10,Bottons[2][2]-10,Bottons[2][3]-10,BLACK)) # desenha um retangulo no botao3
	
	cx = round(Bottons[3][2]/2)
	cy = round(Bottons[3][3] - (offset/2))
	r  = round((offset - 10) /2)
	Menu.append((3,cx,cy,r,BLACK)) # desenha um quadrado no botao4
	
	midx=round(Bottons[4][0]/2)
	midy=Bottons[4][1]+round(offset/2)
	Menu.append((1,Bottons[4][0]+10,Bottons[4][3]-10,round(offsetx/3),Bottons[4][1]+10,BLACK)) #desenha primeira linha da polilinha no botao5
	Menu.append((1,round(offsetx/3),Bottons[4][1]+10,round(offsetx/3)*2,Bottons[4][3]-10,BLACK)) #desenha segunda linha da polilinha no botao5
	Menu.append((1,round(offsetx/3)*2,Bottons[4][3]-10,Bottons[4][2]-10,Bottons[4][1]+10,BLACK)) #desenha terceira linha da polilinha no botao5
    
	Menu.append((6,Bottons[5][0],Bottons[4][3],Bottons[4][2],BLACK))
