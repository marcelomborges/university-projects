...
import model.template.Quarto_Familia;
...
public class CommunicateDAO {
    ...
    public ResultSet povoaCardapio(int quarto){
        Connection con = null;
	PreparedStatement ps = null;
        try {
            con = DataConnect.getConnection();
            ps = con.prepareStatement("Select (Nome,Preco_Uni,ID) from Consumiveis where quartoid=?");
            ps.setInt(1,quarto);
    ...
    public void povoaBancodeDadosQuartos(){
        Connection con = null;
	PreparedStatement ps = null;
        try {
            ps = con.prepareStatement("INSERT INTO CONSUMIVEIS (Quartoid,id,nome,descricao,preco_uni,quantidade) Values (0,5,'Arroz','Arroz',0.5,999999)");
                ps.executeUpdate();
            ps = con.prepareStatement("INSERT INTO CONSUMIVEIS (Quartoid,id,nome,descricao,preco_uni,quantidade) Values (0,6,'Frango','Frango',0.5,999999)");
                ps.executeUpdate();
            ps = con.prepareStatement("INSERT INTO CONSUMIVEIS (Quartoid,id,nome,descricao,preco_uni,quantidade) Values (0,7,'Salada','Salada',0.5,999999)");
                ps.executeUpdate();
            ps = con.prepareStatement("INSERT INTO CONSUMIVEIS (Quartoid,id,nome,descricao,preco_uni,quantidade) Values (0,8,'Vinho','Vinho',0.5,999999)");
                ps.executeUpdate(); 
    ...
    public void povoaBancodeDadosConsumiveis(){
        Connection con = null;
	PreparedStatement ps = null;
        try {
            con = DataConnect.getConnection();
            ps = con.prepareStatement("INSERT INTO CONSUMIVEIS (Quartoid,id,nome,descricao,preco_uni,quantidade) Values (1,1,'Suco','Suco',0.5,999999)");
                ps.executeUpdate();
            ps = con.prepareStatement("INSERT INTO CONSUMIVEIS (Quartoid,id,nome,descricao,preco_uni,quantidade) Values (1,2,'Chocolate','Chocolate',0.5,999999)");
                ps.executeUpdate();
            ps = con.prepareStatement("INSERT INTO CONSUMIVEIS (Quartoid,id,nome,descricao,preco_uni,quantidade) Values (1,3,'Bolo','Bolo',0.5,999999)");
                ps.executeUpdate();
            ps = con.prepareStatement("INSERT INTO CONSUMIVEIS (Quartoid,id,nome,descricao,preco_uni,quantidade) Values (1,4,'Pao','Pao',0.5,999999)");
                ps.executeUpdate();                
        } catch (SQLException ex) {
            System.out.println("Login error atualiza reserva valor -->" + ex.getMessage());
        } finally {
