...
public class FGerente {
    
    CommunicateDAO dao = new CommunicateDAO();
    
//funcionando
    public void CadastraFuncionario(String nome,String cpf,String cargo,String senha,String salario,String rua,String numerocasa,String cidade,String cep,String bairro,String telefone){
        Endereco e;
        EnumCargo c = null;
