...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        # Cria um dicionario para guarda os valores dos pares state-action
    ...
    def computeValueFromQValues(self, state):
        ...
        # Se tem uma action inlegal, então chegamos a um estado terminal
        if len(lActions) == 0:
            return 0
        result = -sys.maxint - 1
        # Ache o maior value Q
