...
public class Fragata extends Embarcacoes {
    ...
    public Fragata(int id, int q, String n) {
        ...
        imagensFragataHorizontal[0] = "FragataHpt1";
        imagensFragataHorizontal[1] = "FragataHpt2";
        imagensFragataHorizontal[2] = "FragataHpt3";
        imagensFragataVertical = new String[3];
        imagensFragataVertical[0] = "FragataVpt1";
        imagensFragataVertical[1] = "FragataVpt2";
        imagensFragataVertical[2] = "FragataVpt3";
    }
