...
public class PortaAvioes extends Embarcacoes {
    ...
    public PortaAvioes(int id, int q, String n) {
        ...
        imagensPortaAvioesHorizontal[0] = "PortaAvioesHpt1";
        imagensPortaAvioesHorizontal[1] = "PortaAvioesHpt2";
        imagensPortaAvioesHorizontal[2] = "PortaAvioesHpt3";
        imagensPortaAvioesHorizontal[3] = "PortaAvioesHpt4";
        imagensPortaAvioesHorizontal[4] = "PortaAvioesHpt5";
        imagensPortaAvioesVertical = new String[5];
        imagensPortaAvioesVertical[0] = "PortaAvioesVpt1";
        imagensPortaAvioesVertical[1] = "PortaAvioesVpt2";
        imagensPortaAvioesVertical[2] = "PortaAvioesVpt3";
        imagensPortaAvioesVertical[3] = "PortaAvioesVpt4";
        imagensPortaAvioesVertical[4] = "PortaAvioesVpt5";
    }
