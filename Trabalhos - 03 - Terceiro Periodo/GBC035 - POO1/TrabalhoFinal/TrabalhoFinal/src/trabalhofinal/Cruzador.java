...
public class Cruzador extends Embarcacoes
{
    ...
    public Cruzador(int id, int q, String n)
    {
        ...
        imagensCruzadorHorizontal[0] = "/imagens/barco2";
        imagensCruzadorHorizontal[1] = "/imagens/barco2";
        imagensCruzadorVertical = new String[2];
        imagensCruzadorVertical[0] = "/imagens/barco2";
        imagensCruzadorVertical[1] = "/imagens/barco2";
    }
