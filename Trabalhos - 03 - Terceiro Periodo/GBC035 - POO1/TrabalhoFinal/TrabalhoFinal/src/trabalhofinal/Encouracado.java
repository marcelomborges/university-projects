...
public class Encouracado extends Embarcacoes
{
    ...
    public Encouracado(int id, int q, String n)
    {
        ...
        imagensEncouracadoHorizontal[0] = "/imagens/barco4";
        imagensEncouracadoHorizontal[1] = "/imagens/barco4";
        imagensEncouracadoHorizontal[2] = "/imagens/barco4";
        imagensEncouracadoHorizontal[3] = "/imagens/barco4";
        imagensEncouracadoVertical = new String[4];
        imagensEncouracadoVertical[0] = "/imagens/barco4";
        imagensEncouracadoVertical[1] = "/imagens/barco4";
        imagensEncouracadoVertical[2] = "/imagens/barco4";
        imagensEncouracadoVertical[3] = "/imagens/barco4";
    }
